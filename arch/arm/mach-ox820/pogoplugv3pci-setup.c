/*
 * arch/arm/mach-ox820/pogoplugv3pci-setup.c
 *
 * Pogoplug V3 (with PCI) Setup
 *
...
static void __init pogoplugv3pci_init(void)
{
...
MACHINE_START(POGOPLUGV3PCI, "Pogoplug V3 PCI")
	/* Maintainer: ALARM */
	#if 0
	...
	.timer = &oxnas_timer,
	.init_machine = pogoplugv3pci_init,
MACHINE_END